---
title: "Meditation for Tennis Players: Between-Point Mental Resets"
slug: meditation-for-tennis
excerpt: "Tennis is mental chess with physical execution. The time between points—those crucial 20-25 seconds—determines whether you play your game or react to your opponent's."
featured_image:
...
status: published
published_at: 2025-02-05T09:00:00
---
...
**Narrow focus**: On contact point, on ball, on specific target
**Broad focus**: On opponent's position, on court geometry, on patterns
...
See [managing competition anxiety](/blog/breathwork-competition-anxiety) for breathing techniques.
...
1. **Physical reset** (5 seconds): Posture, racket position, movement pattern
2. **Mental reset** (10 seconds): Breathing, clearing, presence
3. **Point preparation** (5-10 seconds): Decision, image, readiness
...
**Breathing practice**: [Box breathing](/blog/box-breathing-complete-guide) or simple slow breathing. Extend the parasympathetic activation.
...
See [choking under pressure](/blog/choking-under-pressure-prevention) for more on high-stakes execution.
...
1. **Between-point time** determines match outcomes—use the 25 seconds deliberately
2. **Develop consistent routine**: physical reset, mental reset, point preparation
3. **Changeover meditation** provides deeper recovery every two games
4. **Same routine for all points**—consistency stabilizes pressure moments
5. **Common errors** (score focus, opponent focus, time travel) have specific mental fixes
6. **Daily practice** builds the capacity that matches require

The [Return app](/blog/guide-to-return-meditation-timer) helps you build the daily meditation practice that develops between-point mental skills. Train your mind as systematically as you train your strokes.
