---
title: "PETTLEP Model: Evidence-Based Imagery for Sport"
slug: pettlep-imagery-model
excerpt: "PETTLEP is the research-validated framework for effective sports imagery. Learn each component and how to apply this evidence-based approach to mental rehearsal."
featured_image:
...
**Application**:
- Wear performance clothing during imagery when possible
- Hold equipment (racket, ball, club) during rehearsal
- Stand or assume relevant posture rather than lying down
- Generate appropriate physical activation level
...
**Application**:
- Practice imagery at the competition venue when possible
- If not at venue, use photos, videos, or detailed descriptions
- Include all environmental elements: lighting, crowd, weather, surfaces
- Replicate sounds, temperature, and spatial layout
...
**Application**:
- Rehearse specific skills, plays, or sequences you'll perform
- Include task-relevant cues you'll actually use
- Focus on elements appropriate to your skill level
- Incorporate strategy and decision points
...
**Application**:
- Practice imagery at actual performance speed
- Use slow motion sparingly, primarily for learning or analysis
- Include timing-dependent elements (rhythm, pacing, reaction)
- Maintain realistic duration for sequences
...
**Application**:
- Beginners include more technical focus
- Experts include more automated execution and tactical elements
- Adapt imagery as skills develop
- Address current problem areas or focus points
...
**Application**:
- Include the emotions you want to experience during competition
- Rehearse emotional responses to challenges
- Generate the arousal level appropriate to your optimal performance zone
- Practice emotional regulation within imagery
...
**Application**:
- Internal perspective for tasks emphasizing kinesthetic feel
- External perspective for form-focused work or complex spatial tasks
- Match perspective to what produces clearest, most effective imagery
- Experiment to find what works for different tasks
...
**Setup** (2-3 minutes)
- Put on performance clothing
- Hold relevant equipment
- Assume performance posture
- Generate appropriate physical activation

**Environment priming** (1-2 minutes)
- Recall or construct the performance environment
- Include all sensory details
- Establish the setting vividly

**Task rehearsal** (5-10 minutes)
- Rehearse specific skills or sequences at actual speed
- Focus on current learning priorities
- Include task-relevant cues and decisions

**Emotional integration** (throughout)
- Maintain appropriate emotional state
- Include desired feelings throughout rehearsal

**Perspective management** (throughout)
- Use perspective that produces best results
- Switch perspectives if different phases benefit from different views

The [Return app](/blog/guide-to-return-meditation-timer) can time these structured sessions while you focus on imagery quality.

### Quick PETTLEP

When time is limited, prioritize components with most impact for your situation:

**Minimal essentials**: Task, Timing, Emotion
**Enhanced version**: Add Physical (hold equipment, assume posture)
**Full context**: Add Environment when venue-specific preparation matters
...
Focus on:
- Specific task rehearsal at actual timing
- Correct perspective
- Current learning/focus priorities

### [Pre-shot routines](/blog/pre-competition-routines-elite) can include abbreviated PETTLEP imagery—just the task execution at actual speed with appropriate emotion.
...
[Mental rehearsal during injury](/blog/mental-rehearsal-visualization-athletes) should adapt PETTLEP to what's physically possible while maintaining maximum replication in other components.
...
1. **PETTLEP is an evidence-based framework** for effective sports imagery
2. **Seven components**: Physical, Environment, Task, Timing, Learning, Emotion, Perspective
3. **Functional equivalence principle**: imagery works best when it matches actual performance conditions
4. **Physical elements matter**: wear gear, hold equipment, assume posture
5. **Emotion is essential**: imagery without feeling produces weaker effects
6. **Adapt to context**: full PETTLEP for competition prep, abbreviated versions for quick rehearsal
