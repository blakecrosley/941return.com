---
title: "Clutch Free Throws: Mental Training for High-Pressure Moments"
slug: clutch-free-throws-mental
excerpt: "The free throw line with the game on the line. The penalty kick with millions watching. Mental training for the specific challenge of performing isolated skills under maximum pressure."
featured_image:
...
This is different from [clutch team performance](/blog/clutch-state-performance-pressure). Here, you're alone with a single task, under maximum scrutiny, with the outcome riding on your execution. The mental training for these moments is precise and practicable.
...
Example free throw routine:
1. Receive ball, spin to hand position
2. Three bounces while breathing out
3. Look at rim, visualize ball going through
4. Deep breath in, exhale halfway
5. Shoot (automatic, not consciously initiated)
...
Do this daily, not just before big games. See [mental rehearsal](/blog/mental-rehearsal-visualization-athletes).

### Arousal Management

Physical state affects execution:

**Breathing techniques**: [Box breathing](/blog/box-breathing-complete-guide) before high-pressure moments
...
**Physiological sigh**: [Quick calming technique](/blog/physiological-sigh-technique) if needed
...
See [choking under pressure prevention](/blog/choking-under-pressure-prevention).
...
The [Return app](/blog/guide-to-return-meditation-timer) supports the attention training that underlies clutch performance. Build the focus capacity for when the game is on the line.
