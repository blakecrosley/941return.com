---
title: "Breath Holds and CO2 Tolerance: Advanced Breathing for Performance"
slug: breath-hold-training-athletes
excerpt: "Your discomfort with carbon dioxide may be limiting your performance. Breath hold training builds CO2 tolerance, improves breathing efficiency, and develops mental resilience under respiratory stress."
featured_image:
...
**Method**:
1. Normal breath in, normal breath out
2. Hold after the exhale
3. Time until first definite urge to breathe
4. Resume normal breathing (shouldn't be gasping)

**Interpretation**:
- Under 10 seconds: Low tolerance, significant room for improvement
...
**Week 1-2**:
- 5-10 exhale holds daily
- Hold until first clear urge to breathe
- Full recovery between holds

**Week 3-4**:
- 10-15 holds daily
- Slightly extend past first urge
- Maintain calm recovery

**Week 5+**:
- Progress based on BOLT improvement
- Add walking holds
...
**CO2 Tables**: Fixed holds with decreasing rest
- Example: 8 rounds of 90-second hold with rest decreasing from 2:00 to 1:00

**O2 Tables**: Increasing holds with fixed rest
- Example: 8 rounds with holds increasing from 60 to 120 seconds, 2:00 rest between
...
**Clutch moments**: Calm breathing under pressure. See [clutch performance](/blog/clutch-free-throws-mental).
...
**[Box breathing](/blog/box-breathing-complete-guide)**: Includes hold components

### Breath Holds and PMR

Sequenced practice:

**PMR first**: [Relaxation](/blog/progressive-muscle-relaxation-guide) before breath work
...
The [Return app](/blog/guide-to-return-meditation-timer) provides timing for breath hold practice and meditation. Build the respiratory resilience that enhances athletic performance.
